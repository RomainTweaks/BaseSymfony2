...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'sdz_symfony', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $d, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager517fc0c1e2e25_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager517fc0c1e2e25_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/xampp/htdocs/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_517fc0c1e2e25.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_0d92321987929c49d056a721b5a2006c');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_0d92321987929c49d056a721b5a2006c');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_0d92321987929c49d056a721b5a2006c');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'D:\\xampp\\htdocs\\Symfony\\src\\Sdz\\BlogBundle\\Entity')), 'Sdz\\BlogBundle\\Entity');
        ...
        $e->setProxyDir('D:/xampp/htdocs/Symfony/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager517fc0c1e2e25_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/xampp/htdocs/Symfony/app/cache/dev/jms_diextra/metadata'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return Sdz\BlogBundle\Services\Antispam\MailerAntispam A Sdz\BlogBundle\Services\Antispam\MailerAntispam instance.
     */
    protected function getSdzBlog_AntispamService()
    {
        return $this->services['sdz_blog.antispam'] = new \Sdz\BlogBundle\Services\Antispam\MailerAntispam('\\Swift_Mailer', 'fr', 3);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/xampp/htdocs/Symfony/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/htdocs/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/xampp/htdocs/Symfony/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/xampp/htdocs/Symfony/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/htdocs/Symfony/app/cache/dev/sessions');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setUsername('gandiol.r512@gmail.com');
        $instance->setPassword('Chiffon1');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'D:/xampp/htdocs/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\xampp\\htdocs\\Symfony\\src\\Sdz\\BlogBundle/Resources/views', 'SdzBlog');
     ...
     *
     * @return EntityManager517fc0c1e2e25_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/xampp/htdocs/Symfony/app/cache/dev/jms_security', true));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'sdz_symfony',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'gandiol.r512@gmail.com',
            'mailer_password' => 'Chiffon1',
            'locale' => 'fr',
            ...
            'swiftmailer.transport.smtp.username' => 'gandiol.r512@gmail.com',
            'swiftmailer.transport.smtp.password' => 'Chiffon1',
            ...
            'swiftmailer.spool.memory.path' => 'D:/xampp/htdocs/Symfony/app/cache/dev/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => 'D:/xampp/htdocs/Symfony/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/xampp/htdocs/Symfony/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/xampp/htdocs/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_517fc0c1e2e25.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager517fc0c1e2e25_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/xampp/htdocs/Symfony/app/cache/dev/jms_security',
